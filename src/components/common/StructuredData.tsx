...
const StructuredData: React.FC = () => {
  useEffect(() => {
    ...
    const personSchema = {
      ...
      "description": "Result-driven Frontend Developer specializing in high-performance web applications, sophisticated design systems, and scalable cloud architectures.",
      "knowsAbout": [
        "React",
        "TypeScript",
        "JavaScript",
    ...
    const websiteSchema = {
      ...
      "name": "Jothivasan Portfolio",
      "url": "https://jothivasan.dev",
      "description": "Portfolio website of Jothivasan, a Frontend Developer specializing in modern web applications and design systems.",
      "author": {
        "@type": "Person",
        "name": "Jothivasan"
      },
    ...
    const professionalServiceSchema = {
      ...
      "description": "Professional frontend development services including React development, TypeScript, and modern web applications.",
      "provider": {
        "@type": "Person",
        "name": "Jothivasan"
      },
